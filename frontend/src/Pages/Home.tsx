...
export const Home =()=>{
    const items =[
        <><img src="https://d39vol41m7feya.cloudfront.net/1600098975-pngtree-simple-red-shading-background-illustration-design-backgroundscience-and-technologyred-image_70514.jpg" alt="" className="sliderimg" /><img src="https://images.freekaamaal.com/featured_images/86240_1.jpg" alt="" className="sliderimg" /><img src="https://images.unsplash.com/photo-1573739022854-abceaeb585dc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bW9iaWxlJTIwYWNjZXNzb3JpZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" /></>,
